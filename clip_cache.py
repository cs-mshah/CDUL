...
def main():
    ...
    clip_cache = CLIPCache(dataset, object_categories, save_root, temperature=temperature, batch_size=8)
    ...
    clip_cache = CLIPCache(tile_crop_dataset, object_categories, save_root, temperature=temperature, batch_size=8)
